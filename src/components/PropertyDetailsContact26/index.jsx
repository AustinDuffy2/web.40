...
const PropertyDetailsContact26 = (props) => {
  return (
    <>
...
PropertyDetailsContact26.defaultProps = {
  subheading: "Discover",
  headingSix: "Locations",
  textFour: <>Explore the property&#39;s location on the map</>,
  locationname: "Sydney",
...
export default PropertyDetailsContact26;
